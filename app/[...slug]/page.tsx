                ...
                <article>
                    ...
                    <time dateTime={post.date}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="32" viewBox="0 0 30 32">
                            <rect x="0.5" y="5.5" width="29" height="26" rx="1.5" />
                            <rect x="4.5" y="9.5" width="5" height="4" rx="0.5" />
                            <rect x="4.5" y="16.5" width="5" height="4" rx="0.5" />
                            <rect x="4.5" y="23.5" width="5" height="4" rx="0.5" />
                            <rect x="12.5" y="9.5" width="5" height="4" rx="0.5" />
                            <rect x="12.5" y="16.5" width="5" height="4" rx="0.5" />
                            <rect x="12.5" y="23.5" width="5" height="4" rx="0.5" />
                            <rect x="20.5" y="9.5" width="5" height="4" rx="0.5" />
                            <rect x="20.5" y="16.5" width="5" height="4" rx="0.5" />
                            <rect x="20.5" y="23.5" width="5" height="4" rx="0.5" />
                            <rect x="14.5" y="0.5" width="1" height="7" rx="0.5" />
                            <rect x="6.5" y="0.5" width="1" height="7" rx="0.5" />
                            <rect x="22.5" y="0.5" width="1" height="7" rx="0.5" />
                        </svg> {format(new Date(post.date), "yyyy-MM-dd")}
                    </time>
